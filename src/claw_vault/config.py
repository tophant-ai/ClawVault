...
def get_builtin_presets() -> list[VaultPreset]:
    ...
    return [
        _preset(
            ...
            created_at=now,
            detection=_det(
                "api_keys", "passwords", "ssh_keys", "generic_secrets", "aws_credentials"
            ),
            guard=_guard("strict"),
            file_monitor=_fm(
                watch_patterns=[
            ...
            rules=[
                {
                    "id": "block-leaked-keys",
                    "name": "Block leaked API keys in files",
                    "enabled": True,
                    "action": "block",
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-pii-in-media",
                    "name": "Block PII exposure in media context",
                    "enabled": True,
                    "action": "block",
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-all-credentials",
                    "name": "Block all credential leaks",
                    "enabled": True,
                    "action": "block",
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "sanitize-pii",
                    "name": "Auto-sanitize personal data",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {
                        "has_sensitive": True,
                        "pattern_types": ["pii", "credit_card", "email"],
                    },
                }
            ],
        ),
        _preset(
            ...
            rules=[
                {
                    "id": "block-all-sensitive",
                    "name": "Block all sensitive data",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True},
                },
                ...
                {
                    "id": "block-all-commands",
                    "name": "Block all dangerous commands",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_commands": True},
                },
            ],
        ),
        _preset(
            ...
            rules=[
                {
                    "id": "sanitize-dev-keys",
                    "name": "Sanitize hardcoded API keys",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {
                        "has_sensitive": True,
                ...
                {
                    "id": "ask-on-injection",
                    "name": "Ask user on prompt injection",
                    "enabled": True,
                    "action": "ask_user",
                    "when": {"has_injections": True},
                },
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-cloud-creds",
                    "name": "Block AWS/cloud credential leaks",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "pattern_types": ["aws_credential"]},
                },
                {
                    "id": "block-high-risk-commands",
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-wallet-leak",
                    "name": "Block blockchain wallet leaks",
                    "enabled": True,
                    "action": "block",
                    "when": {
                        "has_sensitive": True,
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-dump-leak",
                    "name": "Block database dump leaks",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "min_risk_score": 6},
                },
                {
                    "id": "sanitize-pii-in-dumps",
                    "name": "Sanitize PII in dumps",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {
                        "has_sensitive": True,
        ...
        _preset(
            ...
            detection=_det(
                ...
                "emails",
                "prompt_injection",
                custom_patterns=[r"\bMRN[-:\s]*\d{6,10}\b", r"\b\d{3}-\d{2}-\d{4}\b"],
            ),
            guard=_guard("strict"),
            file_monitor=_fm(
                watch_home_sensitive=False,
            ...
            rules=[
                {
                    "id": "block-patient-pii",
                    "name": "Block patient PII exposure",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "pattern_types": ["pii", "email"]},
                },
                {
                    "id": "sanitize-health-data",
                    "name": "Sanitize health data",
                    "enabled": True,
                    "action": "sanitize",
            ...
            rules=[
                {
                    ...
                    "name": "Block credit card leaks",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "pattern_types": ["credit_card"]},
                },
                {
                    "id": "block-high-risk-financial",
                    "name": "Block high-risk financial data",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "min_risk_score": 7},
                },
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "allow-all-audited",
                    "name": "Allow all (audit logged)",
                    "enabled": True,
                    "action": "allow",
                    "when": {"has_sensitive": True},
                }
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "sanitize-comm-pii",
                    "name": "Sanitize PII in communications",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {"has_sensitive": True, "pattern_types": ["pii", "email", "phone_cn"]},
                },
                {
                    "id": "ask-on-comm-injection",
                    "name": "Ask on injection in logs",
                    "enabled": True,
                    "action": "ask_user",
                    "when": {"has_injections": True},
                },
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-hardcoded-keys",
                    "name": "Block hardcoded keys in source",
                    "enabled": True,
                    "action": "block",
                    "when": {
                        "has_sensitive": True,
                ...
                {
                    "id": "sanitize-passwords",
                    "name": "Sanitize hardcoded passwords",
                    "enabled": True,
                    "action": "sanitize",
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-ci-secrets",
                    "name": "Block inline CI secrets",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True},
                },
                {
                    "id": "block-ci-dangerous-cmds",
                    "name": "Block high-risk CI commands",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_commands": True, "threat_levels": ["high", "critical"]},
                },
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "block-mobile-secrets",
                    "name": "Block mobile signing secrets",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True},
                },
                {
                    "id": "block-mobile-api-keys",
                    "name": "Block mobile API keys",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "pattern_types": ["api_key", "generic_secret"]},
                },
            ],
        ),
        _preset(
            ...
            rules=[
                {
                    "id": "block-high-risk-archive",
                    "name": "Block high-risk archives",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "min_risk_score": 7},
                }
        ...
        _preset(
            ...
            rules=[
                {
                    "id": "sanitize-legal-pii",
                    "name": "Sanitize PII in contracts",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {"has_sensitive": True, "pattern_types": ["pii", "email"]},
                },
                {
                    "id": "ask-on-legal-risk",
                    "name": "Ask user on risky contract content",
                    "enabled": True,
                    "action": "ask_user",
        ...
        _preset(
            ...
            detection=_det(
                ...
                "generic_secrets",
                "prompt_injection",
                custom_patterns=[r"xox[baprs]-[A-Za-z0-9-]{10,}", r"ntn_[A-Za-z0-9]{40,}"],
            ),
            guard=_guard("interactive"),
            file_monitor=_fm(
                watch_home_sensitive=False,
            ...
            rules=[
                {
                    "id": "sanitize-internal-ids",
                    "name": "Sanitize internal identifiers",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {
                        "has_sensitive": True,
                ...
                {
                    "id": "block-internal-tokens",
                    "name": "Block internal tool tokens",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "pattern_types": ["api_key", "generic_secret"]},
                },
        ...
        _preset(
            ...
            detection=_det(
                ...
                "emails",
                "prompt_injection",
                custom_patterns=[r"\b[A-Z]{2}\d{8,12}\b", r"\b[A-Z]{2}\d{2}[A-Z0-9]{11,30}\b"],
            ),
            guard=_guard("strict", auto_sanitize=False),
            file_monitor=_fm(
                watch_home_sensitive=False,
            ...
            rules=[
                ...
                {
                    "id": "block-gdpr-high-risk",
                    "name": "Block high-risk GDPR data",
                    "enabled": True,
                    "action": "block",
                    "when": {"has_sensitive": True, "threat_levels": ["high", "critical"]},
                },
            ],
        ),
        _preset(
            ...
            rules=[
                {
                    "id": "sanitize-candidate-pii",
                    "name": "Sanitize candidate PII",
                    "enabled": True,
                    "action": "sanitize",
                    "when": {"has_sensitive": True, "pattern_types": ["pii", "email", "phone_cn"]},
                },
                {
                    "id": "ask-on-candidate-risk",
                    "name": "Ask on high-risk candidate data",
                    "enabled": True,
                    "action": "ask_user",
                    "when": {"has_sensitive": True, "min_risk_score": 5},
                },
