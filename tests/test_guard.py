...
def _default_rule_engine(**kwargs):
...
class TestRuleEngine:
    ...
    def test_block_critical_injection(self, detection_engine):
        engine = _default_rule_engine(mode="interactive")
    ...
    def test_strict_mode_blocks_medium(self, detection_engine):
        engine = _default_rule_engine(mode="strict")
    ...
    def test_permissive_mode_allows_medium(self, detection_engine):
        engine = _default_rule_engine(mode="permissive")
    ...
    def test_auto_sanitize(self, detection_engine):
        engine = _default_rule_engine(mode="interactive", auto_sanitize=True)
